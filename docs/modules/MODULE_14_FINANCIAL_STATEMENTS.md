...
- UNIQUE (version_id, statement_type)
...
**Indexes:**
- Primary key on id
- Index on (version_id, statement_type)
...
- UNIQUE (version_id, statement_type, statement_date)
...
**Indexes:**
- Primary key on id
- Index on (version_id, statement_type, statement_date)
