...
- UNIQUE (version_id, academic_period_id, revenue_category, account_code, trimester)
...
**Indexes:**
- Primary key on id
- Index on (version_id, academic_period_id, revenue_category)
...
- UNIQUE (version_id, academic_period_id, level_id, nationality_category)
