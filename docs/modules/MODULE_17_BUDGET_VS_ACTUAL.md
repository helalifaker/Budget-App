...
**Constraints:**
- Unique constraint on (version_id, fiscal_year, period, account_code)
...
1. **One Record Per Comparison**: Unique (version_id, fiscal_year, period, account_code)
...
3. **settings_versions**: Parent table for variance analysis versioning
...
# Budget vs Actual
GET    /api/v1/variance/:version_id                    # Get all variances for budget
GET    /api/v1/variance/:version_id/:period            # Get variances for specific period
POST   /api/v1/variance/:version_id/calculate          # Calculate variances
GET    /api/v1/variance/:version_id/ytd                # Get YTD variances
GET    /api/v1/variance/:version_id/significant        # Get significant variances only
