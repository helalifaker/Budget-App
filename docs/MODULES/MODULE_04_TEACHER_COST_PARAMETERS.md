...
- UNIQUE (budget_version_id, teacher_type, grade_echelon, effective_date)
...
**Indexes:**
- Primary key on id
- Index on (budget_version_id, teacher_type)
...
- UNIQUE (budget_version_id, position_category, effective_date)
- CASCADE delete when budget version deleted
...
**Indexes:**
- Primary key on id
- Index on (budget_version_id, position_category)
