...
- UNIQUE (budget_version_id, level_id, nationality_category, academic_year)
...
**Indexes:**
- Primary key on id
- Unique index on (budget_version_id, level_id, nationality_category)
...
**Constraints:**
- exam_fee_sar >= 0
- UNIQUE (budget_version_id, exam_type, nationality_category, academic_year)
...
**Indexes:**
- Primary key on id
- Index on (budget_version_id, exam_type)
...
- UNIQUE (budget_version_id, trimester, academic_year)
...
**Indexes:**
- Primary key on id
- Index on (budget_version_id, academic_year)
