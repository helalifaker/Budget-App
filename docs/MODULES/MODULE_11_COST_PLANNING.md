...
- UNIQUE (budget_version_id, academic_period_id, cost_category, account_code, cost_center_id)
...
**Indexes:**
- Primary key on id
- Index on (budget_version_id, academic_period_id, cost_category)
...
- UNIQUE (budget_version_id, academic_period_id, cost_item_name, cost_driver)
...
**Indexes:**
- Primary key on id
- Index on (budget_version_id, academic_period_id, cost_driver)
...
- UNIQUE (budget_version_id, academic_period_id, personnel_category)
