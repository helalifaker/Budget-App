...
export const Route = createFileRoute('/_authenticated/insights/variance')({
...
function BudgetVsActualPage() {
  ...
  return (
    <PageContainer
      ...
      breadcrumbs={[
        { label: 'Home', href: '/' },
        { label: 'Insights', href: '/insights/variance' },
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <SummaryCard
                    ...
                    valueClassName={report.total_variance >= 0 ? 'text-green-600' : 'text-red-600'}
                  />
                  <SummaryCard
                  ...
                  <CardContent>
                    <div className="space-y-6">
                      ...
                      {['REVENUE', 'PERSONNEL', 'OPERATING'].map((category) => {
                        ...
                        const categoryVariance = lines.reduce((sum, line) => sum + line.variance, 0)
