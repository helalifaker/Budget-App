/**
 * Configuration Uploads Page - /configuration/uploads
 *
 * Allows administrators to upload historical actuals data from Excel/CSV files.
 * Migrated from /admin/historical-import
 *
 * Features:
...
export const Route = createFileRoute('/_authenticated/configuration/uploads')({
  component: ConfigurationUploadsPage,
})
...
function ConfigurationUploadsPage() {
