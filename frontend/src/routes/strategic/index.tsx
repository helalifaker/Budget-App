...
export const Route = createFileRoute('/strategic/')({
  ...
  return (
    <MainLayout>
      <PageContainer
        ...
        description="Create and manage 5-year strategic plans with scenarios"
        breadcrumbs={[{ label: 'Home', href: '/' }, { label: 'Strategic Planning' }]}
      >
