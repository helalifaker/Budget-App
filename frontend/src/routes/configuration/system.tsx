...
export const Route = createFileRoute('/configuration/system')({
          ...
          <div className="flex items-start gap-2 rounded-md border border-blue-200 bg-blue-50 p-3 text-sm">
            ...
            <div>
              ...
              <p className="text-blue-700">
                Cliquez sur une cellule pour modifier. Les valeurs JSON doivent être valides.
                Format: {'{'}&#34;key&#34;: &#34;value&#34;{'}'}, [1, 2, 3], ou &#34;string&#34;
              </p>
            </div>
          </div>
