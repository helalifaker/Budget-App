...
// Mock the useVersions hook
vi.mock('@/hooks/api/useVersions', () => ({
  useVersions: vi.fn(),
}))

// Type for mocked query results
type MockQueryResult = ReturnType<typeof useVersions>
...
describe('VersionSelector', () => {
  ...
  const renderComponent = (props = {}) => {
    return render(
      <QueryClientProvider client={queryClient}>
        <VersionSelector value={undefined} onChange={mockOnChange} {...props} />
      </QueryClientProvider>
    )
  }
  ...
  describe('Data Handling', () => {
    it('should fetch versions on mount', () => {
      ...
      expect(useVersions).toHaveBeenCalled()
    })
  ...
  describe('Edge Cases', () => {
    ...
    it('should re-render when versions data changes', async () => {
      const { rerender } = render(
        <QueryClientProvider client={queryClient}>
          <VersionSelector value={undefined} onChange={mockOnChange} />
        </QueryClientProvider>
      )
