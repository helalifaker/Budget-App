...
class OdooImportActualsRequest(BaseModel):
    ...
    version_id: UUID = Field(..., description="Budget version to import into")
...
class OdooSyncRequest(BaseModel):
    ...
    version_id: UUID = Field(..., description="Budget version to sync")
    fiscal_year: int = Field(..., description="Fiscal year (e.g., 2025)")
...
class SkolengoExportRequest(BaseModel):
    ...
    version_id: UUID = Field(..., description="Budget version to export from")
