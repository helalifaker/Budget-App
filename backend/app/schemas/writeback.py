...
class CellUpdateResponse(BaseModel):
    ...
    budget_version_id: UUID = Field(..., description="Budget version this cell belongs to")
...
class CellChangeResponse(BaseModel):
    ...
    budget_version_id: UUID = Field(..., description="Budget version")
...
class CellCreateRequest(BaseModel):
    ...
    budget_version_id: UUID = Field(..., description="Budget version for this cell")
