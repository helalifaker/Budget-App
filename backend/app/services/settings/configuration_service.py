...
# Backward compatibility aliases for type hints
...
class ConfigurationService:
    ...
    def __init__(self, session: AsyncSession):
        ...
        self._version = VersionService(session)
    ...
    async def get_version(self, version_id: uuid.UUID) -> BudgetVersion:
        ...
        Note:
            Delegates to VersionService for centralized version management.
        """
        return await self._version.get_version(version_id)
    ...
    async def get_all_versions(
        ...
        Note:
            Delegates to VersionService for centralized version management.
        """
        return await self._version.get_all_versions(
    ...
    async def get_versions_paginated(
        ...
        Note:
            Delegates to VersionService for centralized version management.
        """
        return await self._version.get_versions_paginated(
            page=page,
            page_size=page_size,
            fiscal_year=fiscal_year,
            status=status,
    ...
    async def create_version(
        ...
        Args:
            ...
            school_period: School period (1=Jan-Aug, 2=Sep-Dec, None=Full Year)
        ...
        Raises:
            ...
            BusinessRuleError: If school_period is invalid
    ...
    async def submit_version(
        ...
        Note:
            Delegates to VersionService for centralized version management.
        """
        return await self._version.submit_version(
    ...
    async def approve_version(
        ...
        Note:
            Delegates to VersionService for centralized version management.
        """
        return await self._version.approve_version(
            version_id=version_id,
            user_id=user_id,
        )
    ...
    async def reject_version(
        ...
        Returns:
            Updated BudgetVersion instance (now in WORKING status)
        ...
        Note:
            Delegates to VersionService for centralized version management.
        """
        return await self._version.reject_version(
            version_id=version_id,
            user_id=user_id,
            reason=reason,
        )
    ...
    async def supersede_version(
        ...
        Note:
            Delegates to VersionService for centralized version management.
        """
        return await self._version.supersede_version(
            version_id=version_id,
            user_id=user_id,
        )
    ...
    async def delete_version(
        ...
        Business Rule: Cannot delete approved versions - they must be superseded instead
        ...
        Note:
            Delegates to VersionService for centralized version management.
        """
        await self._version.delete_version(
            version_id=version_id,
            user_id=user_id,
        )
    ...
    async def clone_version(
        ...
        configuration. Clones the version metadata and optionally all configuration data.
        ...
        Note:
            Delegates to VersionService for centralized version management.
        """
        return await self._version.clone_version(
    ...
    async def batch_upsert_class_size_params(
        ...
        Note:
            Delegates to ClassSizeService for centralized parameter management.
        """
        return await self._class_size.batch_upsert_class_size_params(
            version_id=version_id,
            entries=entries,
            user_id=user_id,
        )
        ...
        for subject_code, level_hours in template["hours"].items():
            ...
            for level_code, hours in level_hours.items():
                ...
                query = select(SubjectHoursMatrix).where(
                    and_(
                        SubjectHoursMatrix.version_id == version_id,
