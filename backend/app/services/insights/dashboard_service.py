...
class DashboardService:
    ...
    async def get_dashboard_summary(
        ...
        try:
            ...
            effective_capacity = Decimal(
                str(await get_effective_capacity(self.session, version_id))
            )
    ...
    async def get_enrollment_chart_data(
        ...
        if breakdown_by == "level":
            ...
            # Group by cycle name
            from app.models import AcademicCycle
            ...
            from app.models import NationalityType
    ...
    async def get_recent_activity(
        ...
        if version_id:
            query = query.where(BudgetVersion.id == version_id)
    ...
    async def get_budget_status_widget(
        ...
        # Get alerts count
        alerts = await self.get_alerts(version_id)
