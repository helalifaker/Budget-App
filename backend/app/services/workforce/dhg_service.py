...
class DHGService:
    ...
    async def get_dhg_subject_hours(
        ...
        Performance Notes:
            ...
            - Eager loads subject, level, cycle, version, and audit fields
        ...
        try:
            query = (
                ...
                .options(
                    ...
                    selectinload(DHGSubjectHours.version),
                )
                .order_by(
    ...
    async def get_teacher_requirements(
        ...
        Performance Notes:
            - Uses selectinload for N+1 prevention
            - Eager loads subject, version, and audit fields
        ...
        query = (
            ...
            .options(
                ...
                selectinload(DHGTeacherRequirement.version),
            )
    ...
    async def get_teacher_allocations(
        ...
        Performance Notes:
            - Uses selectinload for N+1 prevention
            - Eager loads subject, cycle, category, version, and audit fields
        ...
        query = (
            ...
            .options(
                ...
                selectinload(TeacherAllocation.version),
            )
            .order_by(
                Subject.code,
