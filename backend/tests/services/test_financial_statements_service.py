...
class TestGetIncomeStatement:
    ...
    async def test_get_income_statement_pcg_format(
        ...
        expense = BudgetConsolidation(
            ...
            source_id=uuid.uuid4(),
            consolidation_category=ConsolidationCategory.TEACHING_SALARIES,
            account_code="64110",
...
class TestGetBalanceSheet:
    ...
    async def test_get_balance_sheet_generates_both_parts(
        ...
        capex = BudgetConsolidation(
            ...
            source_id=uuid.uuid4(),
            consolidation_category=ConsolidationCategory.CAPEX,
            account_code="21500",
...
class TestGetPeriodTotals:
    ...
    async def test_get_period_totals_annual(
        ...
        revenue = BudgetConsolidation(
            ...
            source_table="revenue_plans",
            source_id=uuid.uuid4(),
            consolidation_category=ConsolidationCategory.OTHER_REVENUE,
            account_code="70800",
    ...
    async def test_income_statement_revenue_total(
        ...
        revenues = [
            ...
            BudgetConsolidation(
                ...
                source_table="revenue_plans",
                source_id=uuid.uuid4(),
                consolidation_category=ConsolidationCategory.REGISTRATION_FEES,
                account_code="70140",
                account_name="DAI",
                amount_sar=Decimal("500000.00"),
                is_revenue=True,
    ...
    async def test_income_statement_expense_total(
        ...
        expenses = [
            ...
            BudgetConsolidation(
                ...
                source_id=uuid.uuid4(),
                consolidation_category=ConsolidationCategory.OPERATING_COSTS,
                account_code="61100",
                account_name="Rent",
