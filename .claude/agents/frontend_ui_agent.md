---
agentName: frontend_ui_agent
version: 1.0.0
description: Implements UI with React 18 + TypeScript, shadcn/ui, Handsontable grids, dashboards, navigation, role-based UX, and all 17 modules.
model: sonnet
---
